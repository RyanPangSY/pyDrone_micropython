...
#define MICROPY_HW_MCU_NAME         "STM32F429IGT6"
...
#define MICROPY_HW_SPIFLASH_CS      				(pin_F6)
#define MICROPY_HW_SPIFLASH_SCK     				(pin_F7)
#define MICROPY_HW_SPIFLASH_MOSI    				(pin_F9)
#define MICROPY_HW_SPIFLASH_MISO    				(pin_F8)
...
#define MICROPY_HW_SDRAM_FREQUENCY          (90000) // 9 MHz
