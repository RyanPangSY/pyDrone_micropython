...
#define  nes_malloc(s)		_my_malloc((s), __FILE__, __LINE__)
#define  nes_free(d)		_my_free((void **) &(d), __FILE__, __LINE__)
#define  nes_strdup(s)		_my_strdup((s), __FILE__, __LINE__)
