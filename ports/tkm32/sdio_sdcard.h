...
#ifndef MICROPY_INCLUDED_TKM32_SDIO_SDCARD_H
#define MICROPY_INCLUDED_TKM32_SDIO_SDCARD_H															   
#include "HAL_conf.h"												   
...
uint8_t SD_ReadDisk(uint8_t*buf,uint32_t sector,uint32_t cnt); 	//读SD卡,fatfs/usb调用
uint8_t SD_WriteDisk(uint8_t*buf,uint32_t sector,uint32_t cnt);	//写SD卡,fatfs/usb调用
