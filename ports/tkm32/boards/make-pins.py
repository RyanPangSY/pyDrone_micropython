...
# Must have matching entries in AF_FN_* enum in ../pin_defs_tkm32.h
SUPPORTED_FN = {

    "TIM": ["CH1", "CH2", "CH3", "CH4", "CH1N", "CH2N", "CH3N", "CH1_ETR", "ETR", "BKIN"],
    "I2C": ["SDA", "SCL"],
#    "I2S": ["RX", "TX", "LRC", "BCLK", "MCLK"],
    "UART": ["RX", "TX", "CTS", "RTS"],
