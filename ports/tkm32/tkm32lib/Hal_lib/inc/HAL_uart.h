...
* @}
*/ 
/** @defgroup UART_AUTOFLOWEN
* @{
*/ 
#define UART_FLAG_AUTOFLOWEN								((uint32_t)0x00000004)
#define	UART_HWCONTROL_NONE									~UART_FLAG_AUTOFLOWEN
/** @defgroup UART_Stop_Bits 
* @{
*/ 
#define UART_FLAG_STOP											((uint16_t)0x0004)
...
* @{
*/ 
#define UART_FLAG_PARITY 										((uint16_t)0x0001)
#define UART_FLAG_PSEL 											((uint16_t)0x0002)
...
#define UART_IT_RXBRKEN        ((uint16_t)0x0040)
...
#define UART_FLAG_RXBRK                 ((uint16_t)0x0040)
#define UART_FLAG_RXFERR                ((uint16_t)0x0020)
#define UART_FLAG_RXPERR                ((uint16_t)0x0010)
#define UART_FLAG_RXOERR                ((uint16_t)0x0008)
#define UART_FLAG_RXE                   ((uint16_t)0x0002)
