...
#define IS_GPIO_PULL(PULL) (((PULL) == GPIO_Mode_IPD) || ((PULL) == GPIO_Mode_IPU))
...
//01Studio
#define GPIO_AF0_MCO           		((uint8_t)0x00)  /* MCO 	*/
#define GPIO_AF0_SWDIO        		((uint8_t)0x00)  /* SWDIO */
#define GPIO_AF0_SWCLK           	((uint8_t)0x00)  /* SWCLK */
#define GPIO_AF1_TIM1           	((uint8_t)0x01) /* TIM 1 */
#define GPIO_AF1_TIM2           	((uint8_t)0x01) /* TIM 2 */
#define GPIO_AF2_TIM3   		  		((uint8_t)0x02) /* TIM 3 */
#define GPIO_AF2_TIM4   		  		((uint8_t)0x02) /* TIM 4 */
#define GPIO_AF2_TIM5   		  		((uint8_t)0x02) /* TIM 5 */
#define GPIO_AF2_TIM6   		  		((uint8_t)0x02) /* TIM 6 */
#define GPIO_AF2_TIM7   		  		((uint8_t)0x02) /* TIM 7 */
#define GPIO_AF3_I2S              ((uint8_t)0x03)
#define GPIO_AF4_I2C1             ((uint8_t)0x04) /* I2C 1 */
#define GPIO_AF4_I2C2             ((uint8_t)0x04) /* I2C 2 */
#define GPIO_AF4_I2C3             ((uint8_t)0x04) /* I2C 3 */
#define GPIO_AF5_SPI1             ((uint8_t)0x05) /* SPI 1 */
#define GPIO_AF5_SPI2             ((uint8_t)0x05) /* SPI 2 */
#define GPIO_AF5_SPI3             ((uint8_t)0x05) /* SPI 3 */
#define GPIO_AF5_SPI4             ((uint8_t)0x05) /* SPI 4 */
#define GPIO_AF6_QSPI	          	((uint8_t)0x06)	/* QSPI 4 */
#define GPIO_AF7_UART2	          ((uint8_t)0x07)	/* UART 2 */
#define GPIO_AF7_UART3         		((uint8_t)0x07)	/* UART 3 */
#define GPIO_AF7_UART4         		((uint8_t)0x07)	/* UART 4 */
#define GPIO_AF7_UART5         		((uint8_t)0x07)	/* UART 5 */
#define GPIO_AF8_UART1	          ((uint8_t)0x08)	/* UART 1 */
#define GPIO_AF9_CAN1        			((uint8_t)0x09) /* CAN 1 */
#define GPIO_AF9_CAN2        			((uint8_t)0x09) /* CAN 2 */
#define GPIO_AF10_OTG_FS	        ((uint8_t)0x0A)
#define GPIO_AF11_GPIO			      ((uint8_t)0x0B) /* Normal GPIO */
#define GPIO_AF12_SDIO1      			((uint8_t)0x0C) /* TK80   SDIO 1 */
#define GPIO_AF12_SDIO2      			((uint8_t)0x0C) /* TK80   SDIO 2 */
#define GPIO_AF13_TOUCH        		((uint8_t)0x0D)
#define GPIO_AF14_LTDC            ((uint8_t)0x0E) /* RGB_LTDC AF */

#define IS_GPIO_AF(AF)   (((AF) == GPIO_AF0_MCO)   			|| ((AF) == GPIO_AF0_SWDIO)    || \
                          ((AF) == GPIO_AF0_SWCLK)      || ((AF) == GPIO_AF3_I2S)   	 || \
                          ((AF) == GPIO_AF1_TIM1)       || ((AF) == GPIO_AF1_TIM2)     || \
                          ((AF) == GPIO_AF2_TIM3)       || ((AF) == GPIO_AF2_TIM4)     || \
                          ((AF) == GPIO_AF2_TIM5)       || ((AF) == GPIO_AF2_TIM6)     || \
                          ((AF) == GPIO_AF4_I2C1)       || ((AF) == GPIO_AF4_I2C2)     || \
                          ((AF) == GPIO_AF4_I2C3)       || ((AF) == GPIO_AF5_SPI1)     || \
                          ((AF) == GPIO_AF5_SPI2)       || ((AF) == GPIO_AF5_SPI3)     || \
                          ((AF) == GPIO_AF5_SPI4)       || ((AF) == GPIO_AF6_QSPI)     || \
                          ((AF) == GPIO_AF8_UART1)      || ((AF) == GPIO_AF7_UART2)    || \
                          ((AF) == GPIO_AF7_UART3)      || ((AF) == GPIO_AF7_UART4)    || \
                          ((AF) == GPIO_AF7_UART5)      || ((AF) == GPIO_AF10_OTG_FS)     || \
                          ((AF) == GPIO_AF9_CAN1)       || ((AF) == GPIO_AF9_CAN2)     || \
                          ((AF) == GPIO_AF12_SDIO1)     || ((AF) == GPIO_AF12_SDIO2)   || \
                          ((AF) == GPIO_AF13_TOUCH)  		|| ((AF) == GPIO_AF14_LTDC))
/**
* @}
*/
...
* @}
*/
#define GPIO_GET_IND(__GPIOx__)    (uint8_t)(((__GPIOx__) == (GPIOA))? 0U :\
                                               ((__GPIOx__) == (GPIOB))? 1U :\
                                               ((__GPIOx__) == (GPIOC))? 2U :\
