...
#include "HAL_device.h"
  ...
  */
  ...
  typedef struct
  {
    ...
    uint16_t TIM_OutputNState;  /*!< Specifies the TIM complementary Output Compare state. BIT3
...
#define TIM_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) ((((__HANDLE__)->DIER & (__INTERRUPT__)) == (__INTERRUPT__)) ? SET : RESET)
