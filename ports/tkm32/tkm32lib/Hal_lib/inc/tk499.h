...
#define ADC2                ((ADC_TypeDef *) TOUCHPAD_BASE)
...
#define RCC_PLLCFGR_PLLN											((uint32_t)0x00001FC0)
#define RCC_PLLCFGR_PLLP											((uint32_t)0x00000030)
#define RCC_PLLCFGR_PLLM											((uint32_t)0x0000000F)
