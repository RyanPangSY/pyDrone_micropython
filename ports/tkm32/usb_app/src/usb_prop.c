...
void MASS_Reset()
{
    ...
    _SetEP0_INT_EN( EPn_INT_EN_SETUPIE|EPn_INT_EN_INNACKIE|\
          EPn_INT_EN_OUTACKIE);//EPn_INT_EN_INACKIE|
    _ClrEP0_INT_STA(EPn_INT_STATE_SETUP|EPn_INT_STATE_INNACK|\
          EPn_INT_STATE_OUTACK);


    _SetEP1_INT_EN( EPn_INT_EN_INNACKIE );//| EPn_INT_EN_INACKIE|EPn_INT_EN_INACKIE
    _ClrEP1_INT_STA(EPn_INT_STATE_INNACK| EPn_INT_STATE_INACK);

    _SetEP2_INT_EN( EPn_INT_EN_OUTACKIE );//| EPn_INT_EN_INACKIE
    _ClrEP2_INT_STA(EPn_INT_STATE_OUTACK| EPn_INT_STATE_INACK);
